    ...
    init {
        val linkList = listOf<Link>(
                ...
                "relation" link {
                    this href "address"
                    this type "image/*"
                    this hreflang Locale.CHINESE
                    this name "test name"
                    this title "test title"
                    this profile "test profile"
                    this deprecation URI("deprecation+info")
                    this templated true
                },
                "relation" link {
                    this href "address" profile "test profile"
                    this.templated() deprecation URI("deprecation+info")
                    this title "test title" name "test name" hreflang Locale.CHINESE type "image/*"
                }
        )
